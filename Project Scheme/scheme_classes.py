...
class Frame:
    ...
    def lookup(self, symbol):
        ...
        elif self.parent is not None and type(self.parent) == Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 8
        # used to make new frames when calling user-defined procedures
        # formals - scheme list of symbols, vals scheme list of values
        child = Frame(self)
        while formals != nil:
