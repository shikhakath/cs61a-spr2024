...
def scheme_eval(expr, env, _=None): # Optional third argument is ignored
    ...
    if scheme_symbolp(first) and first in scheme_forms.SPECIAL_FORMS:
        ...
        operator = scheme_eval(first, env) #Procedure instance
        ...
        2. Evaluate all of the operands and collect th results (the argument values) in a Scheme list
...
def scheme_apply(procedure, args, env):
    ...
    if isinstance(procedure, BuiltinProcedure):
        ...
        # BEGIN PROBLEM 9
        new_frame = procedure.env.make_child_frame(procedure.formals, args) # env in which procedure defined
...
def eval_all(expressions, env):
    ...
    """
    # BEGIN PROBLEM 6
    # the value of the begin expression is the value of the final subexpression
    # if eval_all is passed an empty list of expressions (nil), then it should return the Python value None
    # representing Scheme value undefined
    current_exp = None
    if expressions == (nil):
        return None
        ...
        current_exp = eval_all(expressions.rest, env)
    return current_exp
    # END PROBLEM 6
